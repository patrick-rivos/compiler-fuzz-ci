...
WARNING_OPTS="-Werror -Wfatal-errors -Wall -Wformat -Wno-parentheses-equality -Wno-constant-conversion -Wno-pointer-compare -Wno-implicit-const-int-float-conversion -Wno-compare-distinct-pointer-types -Wno-constant-logical-operand -Wno-pointer-sign -Wno-self-assign -Wno-bool-operation -Wno-unused-function -Wno-unused-variable -Wno-address -Wno-unused-value -Wno-tautological-compare -Wno-unused-but-set-variable -Wno-pointer-compare"

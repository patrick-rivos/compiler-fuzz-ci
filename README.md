...
1. [88802: [LoopVectorize] Assertion 'VecTy.SimpleTy != MVT::INVALID_SIMPLE_VALUE_TYPE && "Simple vector VT not representable by simple integer vector VT!"' failed.](https://github.com/llvm/llvm-project/issues/88802)
...
1. [131696: [SLPVectorizer]  Assertion `!empty()' failed. using opt with --passes=slp-vectorizer](https://github.com/llvm/llvm-project/issues/131696)
